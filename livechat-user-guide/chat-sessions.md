...
![Chat session list](/_books/livechat-user-guide/images/chat-session-list.png)
...
![New chat popup](/_books/livechat-user-guide/images/new-chat-popup.png)

<!-- #JA Will these only be displayed when your browser is opened and you are signed in? -->
...
![New message notification](/_books/livechat-user-guide/images/new-message-popup.png)